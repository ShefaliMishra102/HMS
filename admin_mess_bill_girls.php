...
$sql = "SELECT * from mess_bill where hostel_name = 'Girls Hostel'";
...
function myFunction() {
  ...
  for (i = 0; i < tr.length; i++) {
    ...
    <div class="heading">
      <h1>Girls Hostel Mess Bill Details</h1>
    </div>
        ...
        <table id="myTable" callspacing="30px" border="6" callpadding="30px" width="80%">
          ...
          ?>
            <tr>
              ...
              <td><a href="mess_bill_receipt.php?application=<?php echo $rec['application']; ?>"><button type="button" class="btn btn-success">Show</button></a></td>
