...
?>
  ...
  <head>
    ...
    <title>Admin Salary Manage</title>
    ...
    <div class="column middle">
      <form action="" method="POST">
        <table id="myTable" callspacing="30px" border="6" callpadding="30px" width="80%">
          ...
          ?>
            <tr>
              <td><?php echo $rec['emp_id']; ?></p>
              </td>
              <td><?php echo $rec['emp_hos']; ?></p>
              </td>
              <td><?php echo $rec['emp_type']; ?></p>
              </td>
              <td><?php echo $rec['emp_name']; ?></p>
              </td>

              <td><?php echo $rec['salary']; ?></p>
              </td>
              <td><?php echo $rec['s_month']." ".$rec['s_year']; ?></p>
              </td><td><?php echo $rec['time']; ?></p>
              </td>
