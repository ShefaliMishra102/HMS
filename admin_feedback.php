...
?>
  ...
  <head>
    ...
    <title>Admin Feedback Manage</title>
...
function myFunction() {
  ...
  for (i = 0; i < tr.length; i++) {
    ...
    <div class="heading">
      <h1> Feedback /Compaint /Enquiries details</h1>
    </div>
      ...
      <form action="" method="POST">
        <table id="myTable" callspacing="30px" border="6" callpadding="30px" width="80%">
          ...
          <tr class="header" height="60px" font="20px">
            <th>ID</th>
            <th>Compaint Nature</th>
            <th>Block Name $ Room Number</th>
            <th>Hosteller ID</th>
            <th>Name</th>
            <th>Mobile</th>
            <th>Email</th>
          ...
          ?>
            <tr>
              ...
              <td><?php echo $rec['comp']; ?></p>
              </td>
              <td><?php echo $rec['f_bn']. ' ' .$rec['f_rn']; ?></p>
              </td>
              <td><?php echo $rec['stud_id']; ?></p>
              </td>
              <td><?php echo $rec['f_name']; ?></p>
              </td>
              <td><?php echo $rec['f_mobile']; ?></td>
              <td><?php echo $rec['f_id']; ?></td>
              <td><?php echo $rec['topic']; ?></td>
              <td><?php echo $rec['query']; ?></td>
