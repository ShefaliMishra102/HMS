...
<body>
 ...
 -->
	<div class="container">
		...
		<form action="employee_reg_details_update.php?ID=<?php echo $rec['ID']; ?>" method="POST">
			<table>
				<p class="solid">Employee Information</p>
				<hr style="height:05px;background-color:black;color:black">
				<br>

				<tr>
					<th width="200px">Hostel Name:</th>
					<td><input type="text" name="hostel_name" value="<?php echo $rec['hostel_name']; ?>">

					</td>
                    <th width="200px">Designation:</th>
					<td><input type="text" name="emp_type" value="<?php echo $rec['emp_type']; ?>">
                ...
                <tr>
					...
					<td><input type="text" name="e_name" value="<?php echo $rec['e_name']; ?>">
					</td>
				...
				<tr>
					...
					<td><input type="number" name="e_mobile" value="<?php echo $rec['e_mobile']; ?>">
					</td>
		
            		<th width="200px">Gender:</th>
					<td><input type="text" name="e_gender" value="<?php echo $rec['e_gender']; ?>">
					</td>
                </tr>
				...
				<tr>
					...
					<td><input type="date" name="e_dob" value="<?php echo $rec['e_dob']; ?>">
					</td>
				
     				<th width="200px">Category:</th>
					<td><input type="text" name="e_category" value="<?php echo $rec['e_category']; ?>">
					</td>
                </tr>
		    	...
		    	<tr>
					...
					<td><input type="date" name="join_start" value="<?php echo $rec['join_start']; ?>">
					</td>
