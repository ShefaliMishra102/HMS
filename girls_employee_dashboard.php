...
?>
<?php 
$sql30="SELECT COUNT(*) From student where hos='Girls Hostel'";
...
<head>
  ...
  <link rel="stylesheet" type="text/css" href=".\css\employee_dashboard_style.css">

</head>

<body background="./image/bg38.jpg">
      ...
      <div class="col-6">
        <div class="card2">
          <div class="card-title2">
            <h1><?php echo $rec30[0]; ?></h1> <br>
            <h4>Total Student</h4>
          </div>
          <div class="card-footer2"><a href="girls_employee_student.php">View Details</a>
          </div>
        </div>
		<br>
...
?>
	    ...
	    <a href="notice_show_employee.php" class="btn btn-primary" style="align:center">View All</a>
