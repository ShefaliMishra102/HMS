...
$sql = "SELECT * from cost where hostel_name='Girls Hostel'";
...
function myFunction() {
  ...
  for (i = 0; i < tr.length; i++) {
    ...
    <div class="heading">
      <h1>Girls Hostel Cost Manage </h1>
    </div>
    ...
    <div class="column middle">
      ...
      <form action="admin_update_cost_girls.php?ID=<?php echo $rec['ID']; ?>" method="POST">
	  ...
	  <a class="btn btn-primary"  href="admin_add_costs_girls.php" role="button" >
   Add Cost
  </a>	
