...
<body background="./image/bg40.jpg">
    ...
    <form action="girls_eforgetdetails.php" method="POST">
		...
		<div class= "cantainer">
            ...
            <table>
                ...
                <tr>
                    <td><input type="text" placeholder="Enter Name....." name="e_name" required></td>
                </tr>
                <tr>
                    <th>Date Of Birth</th>
                </tr>
                <tr>
                    <td><input type="date" name="e_dob" required></td>
                </tr>
            </table>
