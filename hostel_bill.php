    ...
    <div id="collapseOne" class="accordion-collapse collapse " aria-labelledby="headingOne" data-bs-parent="#accordionExample">
      <div class="accordion-body">
			...
			<div class="card">
				...
				<h5 align='center'>Hostel Slip - 2021</h5>

				<hr>
				<form action="hostel_bill_detail.php" method="POST" enctype="multipart/form-data">
					<div class="row">
						...
						<div class="col-sm-8">
							<table>
								...
								<tr>
									...
									<td><input type="text" name="course" value="<?php echo $rec['course']; ?>"></td>
								</tr>
						...
						<div class="col-sm-4">
							...
							<table align='right'>
								<tr><td align='right'><img src="./image/user.png" height="150" width="150"></td></tr> <tr>
									<td align='right'><input type="file" name="h_photo" value=""/></td>
								</tr>
			...
			<div class="card">
				...
				<div class="row">
					...
					<div class="col-sm-4">
						...
						<table align='right'>
							<tr>
								<td align='right'><img src='<?php echo $rec2['h_photo']; ?>' height='150' width='150'></td>
							</tr>
