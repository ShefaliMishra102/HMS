...
$sql = "SELECT * from employee where hostel_name = 'Boys Hostel'";
...
function myFunction() {
  ...
  for (i = 0; i < tr.length; i++) {
    ...
    <div class="heading">
      <h1>Boys Hostel Employee details</h1>
    </div>
        ...
        <table id="myTable" callspacing="30px" border="6" callpadding="30px" width="80%">
          ...
          ?>
            <tr>
              ...
              <a href="admin_employee_delete_boys.php?ID=<?php echo $rec['ID']; ?>"><button type="button" class="btn btn-danger">Delete</button></a></td>
