        ...
        <table id="myTable" callspacing="30px" border="6" callpadding="30px" width="80%">
          ...
          ?>
            <tr>
              ...
              <td><a href="girls_room_allocation_show_details.php?id=<?php echo $rec['stud_id']; ?>"><button type="button" class="btn btn-success">Edit</button></a>
              <a href="girls_employee_student_room_delete.php?ID=<?php echo $rec['ID']; ?>"><button type="button" class="btn btn-danger">Delete</button></a></td>
            </tr>
        <?php
          }
        }
