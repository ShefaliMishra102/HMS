...
$sql = "SELECT * from student where NOT EXISTS (SELECT * FROM room WHERE room.stud_id = student.ID OR student.hos = 'Girls Hostel' )";
        ...
        ?>
          <div class="container">
            ...
            <div class="row">
              ...
              <div class="col-12">
                For Allocation
                <a href="room_allocation_boys.php?id=<?php echo $rec['ID']; ?>">Click Here</a>
              </div>
            </div>
          </div>
       <?php
