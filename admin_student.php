...
$sql = "SELECT * from student where hos = 'Girls Hostel'";
...
?>
  ...
  <head>
    ...
    <title>Admin Student Manage</title>
...
function myFunction() {
  ...
  for (i = 0; i < tr.length; i++) {
    ...
    <div class="heading">
      <h1>Girls Hostel Student details</h1>
    </div>
        ...
        <table id="myTable" callspacing="30px" border="6" callpadding="30px" width="80%">
          ...
          ?>
            <tr>
              ...
              <a href="admin_student_delete.php?ID=<?php echo $rec['ID']; ?>"><button type="button" class="btn btn-danger">Delete</button></a></td>
